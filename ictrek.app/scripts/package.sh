...
ROUTER_GROUP_ID="com-ictrek-agent-room"
ROUTER_PAGE_ID="dashboard"
ROUTER_IFRAME_SRC="/app/com.ictrek.agent-room/?v=20260716"
ROUTER_HASH_PATH="#/app/com.ictrek.agent-room/com-ictrek-agent-room/dashboard"
